...
## Overall Model Performance (v2.1 Retrained Model — Reference for Group Comparisons)
...
- **SHAP individual fairness:** Not conducted in this audit — requires running SHAP for every test observation (~25,000 rows). Use `POST /predict/explain` manually to compare feature attributions for specific players of interest.
